...
create table history_data(SYMBOL VARCHAR(20),SERIES VARCHAR(10),OPEN FLOAT,HIGH FLOAT,LOW FLOAT,CLOSE FLOAT,LAST FLOAT,PREVCLOSE FLOAT,TOTTRDQTY FLOAT,TOTTRDVAL FLOAT,TIMESTAMP varchar(20),TOTALTRADES FLOAT,col1 varchar(20), PERCCHANGE varchar(20));
